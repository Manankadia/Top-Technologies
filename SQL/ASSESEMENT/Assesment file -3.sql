...
alter table flights add column FlightStatus varchar(50);
update Flight set FlightStatus = 'Scheduled' where flightid =1;
...
update flights set ticketprice = 1500.00 where departurecity = 'london';
 ...
 alter table flights add  departureterminal varchar(50) default 'T1';
...
update flights set flightstutus = 'boarding'where departurecity = 'new york';
